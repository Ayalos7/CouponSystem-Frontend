...
import "./AdminFunctions6.css";

function AdminFunctions6(): JSX.Element {
    ...
    function sendDetails(customerDetails: Customer) {
        ...
        JwtAxios.post(globals.urls.administrator + "Admin/addCustomer", customerDetails)
            .then((response) => {
...
export default AdminFunctions6;
